...
1. Téléchargez **`ProjectOn_2.6.0_Setup.exe`** depuis la [dernière version](https://github.com/elieNy7/project-on/releases/latest).
...
|---|---|
| ![Interface](docs/screenshots/ui-main.png) | ![Projection](docs/screenshots/04-projection-bible.png) |
