...
_translations: dict[str, dict[str, str]] = {
    ...
    # ===== CHURCH SERVICE KIT =====
    "church_service": {"fr": "Ordre du culte", "en": "Order of service"},
    "church_service_tooltip": {"fr": "Créer un ordre du culte (kit église)", "en": "Create an order of service (church kit)"},
    "church_service_title": {"fr": "Titre du culte", "en": "Service title"},
    "church_service_title_placeholder": {"fr": "Ex : Culte du dimanche", "en": "E.g.: Sunday service"},
    "church_name": {"fr": "Église / lieu", "en": "Church / venue"},
    "church_name_placeholder": {"fr": "Ex : Assemblée de Kinshasa", "en": "E.g.: Kinshasa Assembly"},
    "church_preacher": {"fr": "Prédicateur", "en": "Preacher"},
    "church_preacher_placeholder": {"fr": "Ex : Frère Jean", "en": "E.g.: Brother John"},
    "church_theme": {"fr": "Thème / verset directeur", "en": "Theme / key verse"},
    "church_theme_placeholder": {"fr": "Ex : La foi qui agit — Jacques 2:17", "en": "E.g.: Faith in action — James 2:17"},
    "church_announcements": {"fr": "Annonces (une par ligne)", "en": "Announcements (one per line)"},
    "church_announcements_placeholder": {"fr": "Réunion de prière jeudi à 18h\nRépétition de la chorale samedi…", "en": "Prayer meeting Thursday 6pm\nChoir rehearsal Saturday…"},
    "church_sections": {"fr": "Éléments du culte", "en": "Service elements"},
    "church_sections_hint": {"fr": "Un dossier sera créé dans la playlist avec une slide prête à projeter pour chaque élément coché.", "en": "A folder will be created in the playlist with a ready-to-project slide for each checked element."},
    "sec_welcome": {"fr": "Accueil & Bienvenue", "en": "Welcome"},
    "sec_welcome_text": {"fr": "SOYEZ LES BIENVENUS", "en": "WELCOME"},
    "sec_worship": {"fr": "Louange & Adoration", "en": "Praise & Worship"},
    "sec_worship_text": {"fr": "LOUANGE & ADORATION\nChantons ensemble au Seigneur", "en": "PRAISE & WORSHIP\nLet us sing to the Lord together"},
    "sec_prayer": {"fr": "Prière", "en": "Prayer"},
    "sec_prayer_text": {"fr": "MOMENT DE PRIÈRE\nUnissons nos cœurs", "en": "TIME OF PRAYER\nLet us unite our hearts"},
    "sec_reading": {"fr": "Lecture biblique", "en": "Bible reading"},
    "sec_reading_text": {"fr": "LECTURE DE LA PAROLE", "en": "READING OF THE WORD"},
    "sec_sermon": {"fr": "Prédication", "en": "Sermon"},
    "sec_sermon_text": {"fr": "PRÉDICATION", "en": "SERMON"},
    "sec_offering": {"fr": "Offrande & Dîme", "en": "Offering & Tithe"},
    "sec_offering_text": {"fr": "OFFRANDES & DÎMES\n« Dieu aime celui qui donne avec joie » — 2 Corinthiens 9:7", "en": "OFFERINGS & TITHES\n“God loves a cheerful giver” — 2 Corinthians 9:7"},
    "sec_announcements": {"fr": "Annonces", "en": "Announcements"},
    "sec_announcements_header": {"fr": "ANNONCES", "en": "ANNOUNCEMENTS"},
    "sec_communion": {"fr": "Sainte-Cène", "en": "Communion"},
    "sec_communion_text": {"fr": "SAINTE-CÈNE\n« Faites ceci en mémoire de moi » — Luc 22:19", "en": "COMMUNION\n“Do this in remembrance of me” — Luke 22:19"},
    "sec_baptism": {"fr": "Baptême", "en": "Baptism"},
    "sec_baptism_text": {"fr": "BAPTÊME\nCélébrons ceux qui s'engagent avec le Seigneur", "en": "BAPTISM\nCelebrating those committing to the Lord"},
    "sec_dedication": {"fr": "Présentation d'enfant", "en": "Child dedication"},
    "sec_dedication_text": {"fr": "PRÉSENTATION D'ENFANT\nUn héritage de l'Éternel — Psaume 127:3", "en": "CHILD DEDICATION\nA heritage from the Lord — Psalm 127:3"},
    "sec_closing": {"fr": "Bénédiction & Envoi", "en": "Blessing & Sending"},
    "sec_closing_text": {"fr": "BÉNÉDICTION\nAllez en paix, et que Dieu vous garde", "en": "BLESSING\nGo in peace, and may God keep you"},
    # ===== COUNTDOWN =====
    "countdown": {"fr": "Compte à rebours", "en": "Countdown"},
    "countdown_tooltip": {"fr": "Lancer un compte à rebours avant le culte", "en": "Start a countdown before the service"},
    "countdown_message": {"fr": "Message affiché", "en": "Displayed message"},
    "countdown_message_default": {"fr": "LE CULTE COMMENCE DANS", "en": "THE SERVICE STARTS IN"},
    "countdown_duration": {"fr": "Durée", "en": "Duration"},
    "countdown_end_message": {"fr": "Message de fin", "en": "End message"},
    "countdown_end_message_default": {"fr": "SOYEZ LES BIENVENUS !", "en": "WELCOME!"},
    "countdown_start": {"fr": "Démarrer", "en": "Start"},
    "countdown_hint": {"fr": "Le compte à rebours s'affiche en direct sur la projection locale, OBS et NDI. Cliquez sur une slide de la playlist pour l'arrêter.", "en": "The countdown is shown live on the local projection, OBS and NDI. Click a playlist slide to stop it."},
    # ===== PLAYLIST EXPORT / IMPORT =====
    "playlist_export": {"fr": "Exporter la playlist", "en": "Export playlist"},
    "playlist_import": {"fr": "Importer une playlist", "en": "Import playlist"},
    "playlist_export_done": {"fr": "Playlist exportée : {name}", "en": "Playlist exported: {name}"},
    "playlist_import_done": {"fr": "Playlist importée : {name}", "en": "Playlist imported: {name}"},
    "playlist_import_confirm_title": {"fr": "Importer une playlist", "en": "Import playlist"},
    "playlist_import_confirm_msg": {"fr": "L'import remplacera la playlist actuelle. Continuer ?", "en": "Importing will replace the current playlist. Continue?"},
    "playlist_import_error": {"fr": "Impossible d'importer ce fichier de playlist.", "en": "Unable to import this playlist file."},
    "playlist_json_filter": {"fr": "Playlist Project-On (*.json)", "en": "Project-On playlist (*.json)"},
}
