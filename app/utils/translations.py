...
_translations: dict[str, dict[str, str]] = {
    ...
    "stage_empty_hint": {
        "fr": "Choisissez un verset, un cantique ou une prédication dans la bibliothèque",
        "en": "Pick a verse, a hymn or a sermon from the library",
    },
    "chapters": {"fr": "Chapitres", "en": "Chapters"},
    "verse_preview_placeholder": {
        "fr": "Sélectionnez un verset pour l'aperçu…",
        "en": "Select a verse to preview it…",
    },
    ...
    "local_projection_desc": {
        "fr": "Écran cible, 5 compositions et lisibilité professionnelle",
        "en": "Target screen, 5 compositions and professional readability",
    },
    ...
    "lower_third_style": {"fr": "Modes & style OBS", "en": "OBS modes & style"},
    "lower_third_style_desc": {
        "fr": "Lower Third, plein écran, panneau, sous-titre et carte focus",
        "en": "Lower third, fullscreen, panel, subtitle and focus card",
    },
    ...
    "obs_lower_third_title": {"fr": "Paramètres de diffusion OBS", "en": "OBS broadcast settings"},
    ...
    # ── Écran scène (2.0) ──────────────────────────────────────────────
    "stage_display": {"fr": "Écran scène", "en": "Stage display"},
    "stage_display_desc": {
    ...
    "stage_message_hint": {
        ...
        "en": "Message shown on the stage display",
    },
    ...
    "ticker_settings_desc": {
        "fr": "Annonces en défilement continu sous la projection",
        "en": "Continuously scrolling banner under the projection",
    },
    "ticker_enable": {"fr": "Activer le bandeau défilant", "en": "Enable scrolling banner"},
    "ticker_texts": {"fr": "Annonces (une par ligne)", "en": "Announcements (one per line)"},
    "ticker_speed": {"fr": "Vitesse de défilement", "en": "Scrolling speed"},
    ...
    "video_loop_tip": {
        "fr": "Relancer la vidéo automatiquement à la fin",
        "en": "Restart the video automatically when it ends",
    },
}
