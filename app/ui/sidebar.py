...
class Sidebar(QFrame):
    ...
    def __init__(self, parent=None) -> None:
        ...
        # Monétisation masquée (constants.SHOW_DONATE_BUTTONS) : le bouton
        # n'est plus construit tant que le drapeau est à False.
        from app.utils.constants import SHOW_DONATE_BUTTONS

        self.donate_button: QPushButton | None = None
        if SHOW_DONATE_BUTTONS:
