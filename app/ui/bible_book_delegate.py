...
class BibleBookDelegate(QStyledItemDelegate):
    """Delegate pour afficher les livres de la Bible.
    Affiche:
    - Index du livre (Badge/Icone)
    - Nom du livre
    """
    ...
    def __init__(self, parent=None):
        ...
        # Fonts - Initialize with pixel size for cross-DPI consistency
    ...
    def paint(
        ...
        book_name = str(index.data(Qt.ItemDataRole.DisplayRole) or "")
        num = str(index.row() + 1)
        ...
        elided = QFontMetrics(self.title_font).elidedText(
            book_name, Qt.TextElideMode.ElideRight, text_w
        )
        painter.drawText(
            text_rect,
